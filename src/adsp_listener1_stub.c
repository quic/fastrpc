...
static const Parameter parameters[14] = {
	{ SLIM_IFPTR32(0x8, 0x10),
...
static const Parameter *const parameterArrays[26]
    = { (&(parameters[3])),  (&(parameters[4])),  (&(parameters[5])),
	(&(parameters[6])),  (&(parameters[7])),  (&(parameters[8])),
	(&(parameters[9])),  (&(parameters[10])), (&(parameters[10])),
	(&(parameters[3])),  (&(parameters[4])),  (&(parameters[11])),
	(&(parameters[6])),  (&(parameters[7])),  (&(parameters[8])),
	(&(parameters[12])), (&(parameters[13])), (&(parameters[3])),
	(&(parameters[4])),  (&(parameters[12])), (&(parameters[13])),
	(&(parameters[3])),  (&(parameters[9])),  (&(parameters[0])),
	(&(parameters[1])),  (&(parameters[2])) };
static const Method methods[7]
    = { { REMOTE_SCALARS_MAKEX(0, 0, 0x2, 0x0, 0x0, 0x1), 0x4, 0x0, 2, 2,
	  (&(parameterArrays[23])), 0x4, 0x1 },
	{ REMOTE_SCALARS_MAKEX(0, 0, 0x0, 0x0, 0x1, 0x0), 0x0, 0x0, 1, 1,
	  (&(parameterArrays[25])), 0x1, 0x0 },
...
static const Method *const methodArrays[8]
    = { &(methods[0]), &(methods[1]), &(methods[2]), &(methods[3]),
	&(methods[4]), &(methods[4]), &(methods[5]), &(methods[6]) };
static const char strings[183]
    = "invoke_get_in_bufs\0routBufLenReq\0get_in_bufs2\0inBufLenReq\0next_"
      "invoke\0bufsLenReq\0prevResult\0inBuffers\0prevbufs\0outBufs\0prevCtx\0"
      "offset\0handle\0next2\0init2\0close\0init\0open\0ctx\0uri\0sc\0h\0";
static const uint16_t methodStrings[34]
    = { 58, 119, 81,  111, 169, 134, 177, 92,  46,  19,  141, 119,
	81, 102, 169, 134, 177, 14,  70,  33,  169, 127, 14,  70,
	0,  169, 92,  164, 173, 180, 153, 180, 147, 159 };
static const uint16_t methodStringsArrays[8]
    = { 27, 30, 0, 24, 33, 32, 10, 19 };
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(adsp_listener1_slim)
    = { 8,      &(methodArrays[0]),        0,
...
__QAIC_STUB(adsp_listener1_open)(const char *uri,
                                 remote_handle64 *h) __QAIC_STUB_ATTRIBUTE
{
	return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_listener1_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE
{
...
static __inline int
_stub_pack_1(_ATTRIBUTE_UNUSED _allocator *_al,
             _ATTRIBUTE_UNUSED remote_arg *_praIn,
             _ATTRIBUTE_UNUSED remote_arg *_ppraIn[1],
             _ATTRIBUTE_UNUSED remote_arg *_praROut,
             _ATTRIBUTE_UNUSED remote_arg *_ppraROut[1],
...
static __inline void
_count_1(int _numIn[1], int _numROut[1], int _numInH[1], int _numROutH[1],
         _ATTRIBUTE_UNUSED char *_in0[1],
         _ATTRIBUTE_UNUSED uint32_t _in0Len[1])
{
	_numIn[0] += 1;
...
static __inline int
_stub_method(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1],
             ...
             uint32_t _rout7Len[1], char *_rout8[1], uint32_t _rout8Len[1])
{
	...
	for(_ii = 0, _seq_nat2 = (char *)_in2[0]; _ii < (int)_in2Len[0];
		...
		_count_1(
		    _numIn, _numROut, _numInH, _numROutH,
	...
	if(_numIn[0] >= 255) {
		_QAIC_FARF(RUNTIME_ERROR, "ERROR: Unsupported number of "
		                          "input buffers\n");
	...
	_seq_nat6 = (_seq_nat6 + SLIM_IFPTR32(8, 16))) {
		_TRY(_nErr,
		     _stub_pack(
			 _al, (_praIn + 2), _ppraIn, (_praROut + 0), _ppraROut,
			 _praHIn, _ppraHIn, _praHROut, _ppraHROut,
			 _seq_primIn6, 0,
			 SLIM_IFPTR32((char **)&(((uint32_t *)_seq_nat6)[0]),
		                      (char **)&(((uint64_t *)_seq_nat6)[0])),
			 SLIM_IFPTR32(
			     (uint32_t *)&(((uint32_t *)_seq_nat6)[1]),
			     (uint32_t *)&(((uint32_t *)_seq_nat6)[2]))));
	}
	...
	_TRY_FARF(_nErr, __QAIC_REMOTE(remote_handle64_invoke)(
				 ...
				 0, _mid, (_numIn[0] + 1), (_numROut[0] + 1),
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_listener1_next_invoke)(
    remote_handle64 _handle, adsp_listener1_invoke_ctx prevCtx, int prevResult,
    ...
    int routBufLenReqLen) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 2;
	return _stub_method(
	    _handle, _mid, (uint32_t *)&prevCtx, (uint32_t *)&prevResult,
	    (void **)&outBufs, (uint32_t *)&outBufsLen, (uint32_t *)ctx,
...
static __inline int
_stub_pack_2(_ATTRIBUTE_UNUSED _allocator *_al,
             _ATTRIBUTE_UNUSED remote_arg *_praIn,
             _ATTRIBUTE_UNUSED remote_arg *_ppraIn[1],
             _ATTRIBUTE_UNUSED remote_arg *_praROut,
             _ATTRIBUTE_UNUSED remote_arg *_ppraROut[1],
...
static __inline int
_stub_method_1(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1],
               void *_rout1[1], uint32_t _rout1Len[1])
{
	remote_arg *_pra = 0;
	int _numIn[1] = { 0 };
	int _numROut[1] = { 0 };
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_listener1_invoke_get_in_bufs)(
    remote_handle64 _handle, adsp_listener1_invoke_ctx ctx,
    adsp_listener1_buffer *inBuffers, int inBuffersLen) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 3;
	return _stub_method_1(_handle, _mid, (uint32_t *)&ctx,
	                      (void **)&inBuffers, (uint32_t *)&inBuffersLen);
}
static __inline int
_stub_method_2(remote_handle64 _handle, uint32_t _mid)
{
	remote_arg *_pra = 0;
	int _nErr = 0;
	_TRY_FARF(_nErr, __QAIC_REMOTE(remote_handle64_invoke)(
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_listener1_init)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 4;
	return _stub_method_2(_handle, _mid);
}
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_listener1_init2)(remote_handle64 _handle)
...
static __inline int
_stub_method_3(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1],
               uint32_t _in1[1], char *_in2[1], uint32_t _in2Len[1],
               uint32_t _rout3[1], uint32_t _rout4[1], uint32_t _rout5[1],
               char *_rout6[1], uint32_t _rout6Len[1], uint32_t _rout7[1])
{
	int _numIn[1] = { 0 };
	remote_arg _pra[4] = { 0 };
	...
	_TRY_FARF(_nErr, __QAIC_REMOTE(remote_handle64_invoke)(
			     _handle,
			     REMOTE_SCALARS_MAKEX(0, _mid, 2, 2, 0, 0), _pra));
	_COPY(_rout3, 0, _primROut, 0, 4);
	_COPY(_rout4, 0, _primROut, 4, 4);
	_COPY(_rout5, 0, _primROut, 8, 4);
	...
	_CATCH_FARF(_nErr)
	{
		_QAIC_FARF(RUNTIME_ERROR,
		           ...
		           ", scalar=0x%x, method ID=%d: %s failed\n",
		           _nErr, _handle,
		           REMOTE_SCALARS_MAKEX(0, _mid, 2, 2, 0, 0), _mid,
		           __func__);
	}
	return _nErr;
}
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_listener1_next2)(
    remote_handle64 _handle, adsp_listener1_invoke_ctx prevCtx, int prevResult,
    ...
    int bufsLen, int *bufsLenReq) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 6;
	return _stub_method_3(
	    _handle, _mid, (uint32_t *)&prevCtx, (uint32_t *)&prevResult,
	    (char **)&prevbufs, (uint32_t *)&prevbufsLen, (uint32_t *)ctx,
	    (uint32_t *)handle, (uint32_t *)sc, (char **)&bufs,
	    (uint32_t *)&bufsLen, (uint32_t *)bufsLenReq);
}
static __inline int
_stub_method_4(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1],
               uint32_t _in1[1], char *_rout2[1], uint32_t _rout2Len[1],
               uint32_t _rout3[1])
{
	int _numIn[1] = { 0 };
	remote_arg _pra[3] = { 0 };
	...
	_TRY_FARF(_nErr, __QAIC_REMOTE(remote_handle64_invoke)(
			     _handle,
			     REMOTE_SCALARS_MAKEX(0, _mid, 1, 2, 0, 0), _pra));
	_COPY(_rout3, 0, _primROut, 0, 4);
	_CATCH_FARF(_nErr)
	{
		_QAIC_FARF(RUNTIME_ERROR,
		           ...
		           ", scalar=0x%x, method ID=%d: %s failed\n",
		           _nErr, _handle,
		           REMOTE_SCALARS_MAKEX(0, _mid, 1, 2, 0, 0), _mid,
		           __func__);
	}
	return _nErr;
}
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_listener1_get_in_bufs2)(remote_handle64 _handle,
                                         adsp_listener1_invoke_ctx ctx,
                                         int offset, uint8_t *bufs,
                                         int bufsLen,
                                         int *bufsLenReq) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 7;
	return _stub_method_4(_handle, _mid, (uint32_t *)&ctx,
	                      (uint32_t *)&offset, (char **)&bufs,
	                      (uint32_t *)&bufsLen, (uint32_t *)bufsLenReq);
}
#ifdef __cplusplus
}
