...
static const char strings[103] =
    "set_param\0grow_"
    "heap\0phyAddr\0dlerror\0params\0close1\0handle\0reqID\0nSize\0open1\0close"
    "\0nErr\0name\0open\0uri\0h\0";
static const uint16_t methodStrings[20] = {69, 86, 50, 28,  81, 43, 50,
                                           28, 81, 0,  57,  36, 10, 20,
                                           63, 91, 96, 100, 75, 100};
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(remotectl1_grow_heap)(remote_handle64 _handle, uint32 phyAddr,
...
static __inline int _stub_method_3(remote_handle64 _handle, uint32_t _mid,
  ...
  _CATCH_FARF(_nErr) {
    _QAIC_FARF(RUNTIME_ERROR,
               "ERROR 0x%x: handle=0x%" PRIx64
               ", scalar=0x%x, method ID=%d: %s failed\n",
               _nErr, _handle, REMOTE_SCALARS_MAKEX(0, _mid, 2, 0, 0, 0), _mid,
               __func__);
  }
  return _nErr;
}
