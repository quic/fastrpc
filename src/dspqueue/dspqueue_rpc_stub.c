...
#ifndef _DSPQUEUE_RPC_STUB_H
#define _DSPQUEUE_RPC_STUB_H
...
#ifndef _DSPQUEUE_RPC_SLIM_H
#define _DSPQUEUE_RPC_SLIM_H
#include <stdint.h>
...
static const Parameter *const parameterArrays[9] = {
...
static const Method methods[8] = {
    ...
    {REMOTE_SCALARS_MAKEX(0, 0, 0x0, 0x0, 0x1, 0x0), 0x0, 0x0, 1, 1,
     (&(parameterArrays[8])), 0x1, 0x0},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x0, 0x0, 0x0), 0x4, 0x0, 1, 1,
     (&(parameterArrays[1])), 0x4, 0x0},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x1, 0x0, 0x0), 0xc, 0x8, 4, 4,
     (&(parameterArrays[0])), 0x4, 0x8},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x0, 0x0, 0x0), 0x8, 0x0, 3, 1,
     (&(parameterArrays[4])), 0x8, 0x0},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x1, 0x0, 0x0), 0x8, 0x4, 4, 2,
     (&(parameterArrays[4])), 0x8, 0x4},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x0, 0x1, 0x0, 0x0), 0x0, 0x4, 1, 1,
     (&(parameterArrays[5])), 0x1, 0x4},
...
static const Method *const methodArrays[9] = {
    ...
    &(methods[5]), &(methods[6]), &(methods[7]), &(methods[7])};
static const char strings[136] =
    "cancel_wait_signal\0init_process_state\0process_state_fd\0destroy_"
    "queue\0create_queue\0is_imported\0queue_id\0queue_"
    "fd\0count\0close\0open\0uri\0h\0";
static const uint16_t methodStrings[20] = {69, 100, 103, 112, 94,  82, 94,
                                           85, 124, 129, 133, 7,   12, 55,
                                           94, 19,  38,  118, 133, 0};
static const uint16_t methodStringsArrays[9] = {8, 17, 15, 0, 13,
                                                5, 11, 19, 12};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(dspqueue_rpc_slim) = {
    9,      &(methodArrays[0]), 0, 0, &(methodStringsArrays[0]), methodStrings,
    strings};
#endif //_DSPQUEUE_RPC_SLIM_H

#ifdef __cplusplus
extern "C" {
#endif
__QAIC_STUB_EXPORT int
__QAIC_STUB(dspqueue_rpc_open)(const char *uri,
                               remote_handle64 *h) __QAIC_STUB_ATTRIBUTE {
  return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int
__QAIC_STUB(dspqueue_rpc_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(dspqueue_rpc_init_process_state)(
    remote_handle64 _handle, int32 process_state_fd) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 2;
...
static __inline int _stub_method_1(remote_handle64 _handle, uint32_t _mid,
                                   ...
                                   uint32_t _in2[1], uint64_t _rout3[1]) {
  int _numIn[1] = {0};
  remote_arg _pra[2] = {0};
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(dspqueue_rpc_create_queue)(
    remote_handle64 _handle, uint32 id, int32 queue_fd, uint32 count,
    uint64 *queue_id) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 3;
  return _stub_method_1(_handle, _mid, (uint32_t *)&id, (uint32_t *)&queue_fd,
                        (uint32_t *)&count, (uint64_t *)queue_id);
}
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(dspqueue_rpc_destroy_queue)(
    remote_handle64 _handle, uint64 queue_id) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 4;
...
static __inline int _stub_method_3(remote_handle64 _handle, uint32_t _mid,
                                   uint64_t _in0[1], uint32_t _rout1[1]) {
  int _numIn[1] = {0};
  remote_arg _pra[2] = {0};
  uint64_t _primIn[1] = {0};
...
__QAIC_STUB(dspqueue_rpc_is_imported)(remote_handle64 _handle, uint64 queue_id,
                                      int32 *imported) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 5;
  return _stub_method_3(_handle, _mid, (uint64_t *)&queue_id,
                        (uint32_t *)imported);
}
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(dspqueue_rpc_wait_signal)(
    remote_handle64 _handle, int32 *signal) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 6;
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(dspqueue_rpc_cancel_wait_signal)(
    remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 7;
  return _stub_method_5(_handle, _mid);
}
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(dspqueue_rpc_signal)(
    remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 8;
  return _stub_method_5(_handle, _mid);
}
