...
static const uint16_t methodStrings[20]
    = { 69,  100, 103, 112, 94, 82, 94, 85,  124, 129,
	133, 7,   12,  55,  94, 19, 38, 118, 133, 0 };
static const uint16_t methodStringsArrays[9]
    = { 8, 17, 15, 0, 13, 5, 11, 19, 12 };
...
__QAIC_STUB(dspqueue_rpc_init_process_state)(
    remote_handle64 _handle, int32_t process_state_fd) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 2;
...
_stub_method_1(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1],
               uint32_t _in1[1], uint32_t _in2[1], uint64_t _rout3[1])
{
	int _numIn[1] = { 0 };
	remote_arg _pra[2] = { 0 };
...
__QAIC_STUB_EXPORT AEEResult
__QAIC_STUB(dspqueue_rpc_create_queue)(
    remote_handle64 _handle, uint32_t id, int32_t queue_fd, uint32_t count,
    uint64_t *queue_id) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 3;
	return _stub_method_1(_handle, _mid, (uint32_t *)&id,
	                      (uint32_t *)&queue_fd, (uint32_t *)&count,
	                      (uint64_t *)queue_id);
}
static __inline int
_stub_method_2(remote_handle64 _handle, uint32_t _mid, uint64_t _in0[1])
{
	remote_arg _pra[1] = { 0 };
...
__QAIC_STUB_EXPORT AEEResult
__QAIC_STUB(dspqueue_rpc_destroy_queue)(
    remote_handle64 _handle, uint64_t queue_id) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 4;
	return _stub_method_2(_handle, _mid, (uint64_t *)&queue_id);
}
static __inline int
_stub_method_3(remote_handle64 _handle, uint32_t _mid, uint64_t _in0[1],
               uint32_t _rout1[1])
{
	int _numIn[1] = { 0 };
	remote_arg _pra[2] = { 0 };
...
__QAIC_STUB_EXPORT AEEResult
__QAIC_STUB(dspqueue_rpc_is_imported)(remote_handle64 _handle,
                                      uint64_t queue_id,
                                      int32_t *imported) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 5;
...
static __inline int
_stub_method_4(remote_handle64 _handle, uint32_t _mid, uint32_t _rout0[1])
{
	int _numIn[1] = { 0 };
	remote_arg _pra[1] = { 0 };
	uint32_t _primROut[1] = { 0 };
...
__QAIC_STUB_EXPORT AEEResult
__QAIC_STUB(dspqueue_rpc_wait_signal)(remote_handle64 _handle,
                                      int32_t *signal) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 6;
	return _stub_method_4(_handle, _mid, (uint32_t *)signal);
}
static __inline int
_stub_method_5(remote_handle64 _handle, uint32_t _mid)
{
	remote_arg *_pra = 0;
	int _nErr = 0;
	_TRY(_nErr,
...
__QAIC_STUB_EXPORT AEEResult
__QAIC_STUB(dspqueue_rpc_cancel_wait_signal)(remote_handle64 _handle)
...
__QAIC_STUB_EXPORT AEEResult
__QAIC_STUB(dspqueue_rpc_signal)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 8;
	return _stub_method_5(_handle, _mid);
}
