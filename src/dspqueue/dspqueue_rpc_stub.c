...
static const Parameter* const parameterArrays[9] = {(&(parameters[4])),(&(parameters[3])),(&(parameters[4])),(&(parameters[5])),(&(parameters[6])),(&(parameters[7])),(&(parameters[0])),(&(parameters[1])),(&(parameters[2]))};
static const Method methods[8] = {{REMOTE_SCALARS_MAKEX(0,0,0x2,0x0,0x0,0x1),0x4,0x0,2,2,(&(parameterArrays[6])),0x4,0x1},{REMOTE_SCALARS_MAKEX(0,0,0x0,0x0,0x1,0x0),0x0,0x0,1,1,(&(parameterArrays[8])),0x1,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x0,0x0,0x0),0x4,0x0,1,1,(&(parameterArrays[1])),0x4,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x1,0x0,0x0),0xc,0x8,4,4,(&(parameterArrays[0])),0x4,0x8},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x0,0x0,0x0),0x8,0x0,3,1,(&(parameterArrays[4])),0x8,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x1,0x0,0x0),0x8,0x4,4,2,(&(parameterArrays[4])),0x8,0x4},{REMOTE_SCALARS_MAKEX(0,0,0x0,0x1,0x0,0x0),0x0,0x4,1,1,(&(parameterArrays[5])),0x1,0x4},{REMOTE_SCALARS_MAKEX(0,0,0x0,0x0,0x0,0x0),0x0,0x0,0,0,0,0x0,0x0}};
static const Method* const methodArrays[9] = {&(methods[0]),&(methods[1]),&(methods[2]),&(methods[3]),&(methods[4]),&(methods[5]),&(methods[6]),&(methods[7]),&(methods[7])};
static const char strings[136] = "cancel_wait_signal\0init_process_state\0process_state_fd\0destroy_queue\0create_queue\0is_imported\0queue_id\0queue_fd\0count\0close\0open\0uri\0h\0";
static const uint16_t methodStrings[20] = {69,100,103,112,94,82,94,85,124,129,133,7,12,55,94,19,38,118,133,0};
static const uint16_t methodStringsArrays[9] = {8,17,15,0,13,5,11,19,12};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(dspqueue_rpc_slim) = {9,&(methodArrays[0]),0,0,&(methodStringsArrays [0]),methodStrings,strings};
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(dspqueue_rpc_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dspqueue_rpc_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
...
static __inline int _stub_method_1(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1], uint32_t _in1[1], uint32_t _in2[1], uint64_t _rout3[1]) {
   int _numIn[1] = {0};
   remote_arg _pra[2] = {0};
...
static __inline int _stub_method_2(remote_handle64 _handle, uint32_t _mid, uint64_t _in0[1]) {
   remote_arg _pra[1] = {0};
...
static __inline int _stub_method_3(remote_handle64 _handle, uint32_t _mid, uint64_t _in0[1], uint32_t _rout1[1]) {
   int _numIn[1] = {0};
   remote_arg _pra[2] = {0};
   uint64_t _primIn[1]= {0};
...
static __inline int _stub_method_4(remote_handle64 _handle, uint32_t _mid, uint32_t _rout0[1]) {
   int _numIn[1] = {0};
   remote_arg _pra[1] = {0};
   uint32_t _primROut[1]= {0};
   int _nErr = 0;
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(dspqueue_rpc_cancel_wait_signal)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 7;
   return _stub_method_5(_handle, _mid);
}
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(dspqueue_rpc_signal)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 8;
   return _stub_method_5(_handle, _mid);
}
#ifdef __cplusplus
