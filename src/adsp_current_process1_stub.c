...
static const char strings[185]
    = "enable_notifications\0set_logging_params2\0set_logging_params\0panic_"
      "err_codes\0thread_exit\0filesToLog\0poll_"
      "mode\0exception\0timeout\0latency\0getASID\0enable\0setQoS\0close\0asid"
      "\0mask\0open\0uri\0h\0";
...
static const uint16_t methodStringsArrays[12]
    = { 9, 18, 23, 22, 6, 16, 14, 21, 3, 0, 20, 12 };
...
__QAIC_STUB(adsp_current_process1_open)(const char *uri, remote_handle64 *h)
    __QAIC_STUB_ATTRIBUTE
{
	return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_close)(remote_handle64 h)
    __QAIC_STUB_ATTRIBUTE
{
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_exit)(remote_handle64 _handle)
    __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 2;
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_thread_exit)(remote_handle64 _handle)
    __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 3;
	return _stub_method(_handle, _mid);
...
static __inline int
_stub_method_1(remote_handle64 _handle, uint32_t _mid, uint16_t _in0[1],
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_set_logging_params)(
    remote_handle64 _handle, unsigned short mask,
    const _cstring1_t *filesToLog, int filesToLogLen) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 4;
...
static __inline int
_stub_method_2(remote_handle64 _handle, uint32_t _mid, uint32_t _rout0[1])
{
	int _numIn[1] = { 0 };
	remote_arg _pra[1] = { 0 };
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_getASID)(
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_setQoS)(
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_exception)(remote_handle64 _handle)
    __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 7;
	return _stub_method(_handle, _mid);
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_set_logging_params2)(
...
static __inline int
_stub_method_5(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1],
               uint32_t _in1[1])
{
	remote_arg _pra[1] = { 0 };
	uint32_t _primIn[2] = { 0 };
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_poll_mode)(
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_enable_notifications)(
...
static __inline int
_stub_method_6(remote_handle64 _handle, uint32_t _mid, char *_in0[1],
               uint32_t _in0Len[1])
{
	remote_arg _pra[2] = { 0 };
	uint32_t _primIn[1] = { 0 };
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_current_process1_panic_err_codes)(
