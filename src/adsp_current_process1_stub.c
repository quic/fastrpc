...
static const Type types[2] = {{SLIM_IFPTR32(0x8,0x10),{{(const uintptr_t)0x0,0}}, 4,SLIM_IFPTR32(0x4,0x8)},{0x4,{{(const uintptr_t)0,(const uintptr_t)1}}, 2,0x4}};
...
static const Parameter* const parameterArrays[11] = {(&(parameters[6])),(&(parameters[6])),(&(parameters[6])),(&(parameters[4])),(&(parameters[3])),(&(parameters[4])),(&(parameters[0])),(&(parameters[1])),(&(parameters[7])),(&(parameters[5])),(&(parameters[2]))};
static const Method methods[9] = {{REMOTE_SCALARS_MAKEX(0,0,0x2,0x0,0x0,0x1),0x4,0x0,2,2,(&(parameterArrays[6])),0x4,0x1},{REMOTE_SCALARS_MAKEX(0,0,0x0,0x0,0x1,0x0),0x0,0x0,1,1,(&(parameterArrays[10])),0x1,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x0,0x0,0x0,0x0),0x0,0x0,0,0,0,0x0,0x0},{REMOTE_SCALARS_MAKEX(0,0,255,255,15,15),0x8,0x0,3,2,(&(parameterArrays[4])),0x4,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x0,0x1,0x0,0x0),0x0,0x4,1,1,(&(parameterArrays[9])),0x1,0x4},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x0,0x0,0x0),0x4,0x0,1,1,(&(parameterArrays[0])),0x4,0x0},{REMOTE_SCALARS_MAKEX(0,0,255,255,15,15),0x8,0x0,3,2,(&(parameterArrays[2])),0x4,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x0,0x0,0x0),0x8,0x0,2,2,(&(parameterArrays[0])),0x4,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x2,0x0,0x0,0x0),0x4,0x0,2,1,(&(parameterArrays[8])),0x4,0x0}};
static const Method* const methodArrays[12] = {&(methods[0]),&(methods[1]),&(methods[2]),&(methods[2]),&(methods[3]),&(methods[4]),&(methods[5]),&(methods[2]),&(methods[6]),&(methods[7]),&(methods[2]),&(methods[8])};
static const char strings[185] = "enable_notifications\0set_logging_params2\0set_logging_params\0panic_err_codes\0thread_exit\0filesToLog\0poll_mode\0exception\0timeout\0latency\0getASID\0enable\0setQoS\0close\0asid\0mask\0open\0uri\0h\0";
static const uint16_t methodStrings[24] = {99,143,119,21,168,88,41,168,88,173,178,182,60,66,150,127,135,163,157,182,0,109,76,83};
static const uint16_t methodStringsArrays[12] = {9,18,23,22,6,16,14,21,3,0,20,12};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(adsp_current_process1_slim) = {12,&(methodArrays[0]),0,0,&(methodStringsArrays [0]),methodStrings,strings};
...
static __inline int _stub_unpack(_ATTRIBUTE_UNUSED remote_arg* _praROutPost, _ATTRIBUTE_UNUSED remote_arg* _ppraROutPost[1], _ATTRIBUTE_UNUSED void* _primROut, _ATTRIBUTE_UNUSED char* _in0[1], _ATTRIBUTE_UNUSED uint32_t _in0Len[1]) {
   int _nErr = 0;
...
static __inline void _count(int _numIn[1], int _numROut[1], int _numInH[1], int _numROutH[1]) {
   _numIn[0] += 1;
   _numROut[0] += 0;
   _numInH[0] += 0;
   _numROutH[0] += 0;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process1_setQoS)(remote_handle64 _handle, unsigned int latency) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 6;
   return _stub_method_3(_handle, _mid, (uint32_t*)&latency);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process1_exception)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 7;
   return _stub_method(_handle, _mid);
}
static __inline int _stub_method_4(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1], void* _in1[1], uint32_t _in1Len[1]) {
   remote_arg* _pra = 0;
   int _numIn[1] = {0};
   int _numROut[1] = {0};
   int _numInH[1] = {0};
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process1_set_logging_params2)(remote_handle64 _handle, unsigned int mask, const _cstring1_t* filesToLog, int filesToLogLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 8;
   return _stub_method_4(_handle, _mid, (uint32_t*)&mask, (void**)&filesToLog, (uint32_t*)&filesToLogLen);
}
static __inline int _stub_method_5(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1], uint32_t _in1[1]) {
   remote_arg _pra[1] = {0};
   uint32_t _primIn[2]= {0};
   int _nErr = 0;
   _pra[0].buf.pv = (void*)_primIn;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process1_poll_mode)(remote_handle64 _handle, unsigned int enable, unsigned int timeout) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 9;
   return _stub_method_5(_handle, _mid, (uint32_t*)&enable, (uint32_t*)&timeout);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process1_enable_notifications)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 10;
   return _stub_method(_handle, _mid);
}
static __inline int _stub_method_6(remote_handle64 _handle, uint32_t _mid, char* _in0[1], uint32_t _in0Len[1]) {
   remote_arg _pra[2] = {0};
   uint32_t _primIn[1]= {0};
   remote_arg* _praIn = 0;
   int _nErr = 0;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process1_panic_err_codes)(remote_handle64 _handle, const int* err_codes, int err_codesLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 11;
