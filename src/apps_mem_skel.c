...
static const char strings[170]
    = "dma_handle_unmap\0request_unmap64\0dma_handle_map\0request_"
      "map64\0request_unmap\0share_unmap\0request_map\0share_map\0ion_"
...
static __inline int
_skel_method(int (*_pfn)(int, int), uint32_t _sc, remote_arg *_pra)
{
...
static __inline int
_skel_method_1(int (*_pfn)(int, int, int), uint32_t _sc, remote_arg *_pra)
{
	remote_arg *_praEnd = 0;
	uint32_t _in0[1] = { 0 };
	uint32_t _in1[1] = { 0 };
...
static __inline int
_skel_method_2(int (*_pfn)(uint64_t, int), uint32_t _sc, remote_arg *_pra)
{
	remote_arg *_praEnd = 0;
	uint64_t _in0[1] = { 0 };
	uint32_t _in1[1] = { 0 };
...
static __inline int
_skel_method_3(int (*_pfn)(int, int, uint64_t *, uint64_t *), uint32_t _sc,
               remote_arg *_pra)
{
	remote_arg *_praEnd = 0;
	uint32_t _in0[1] = { 0 };
	...
	_COPY(_in0, 0, _primIn, 0, 4);
	_COPY(_in1, 0, _primIn, 4, 4);
	_TRY(_nErr, _pfn((int)*_in0, (int)*_in1, (uint64_t *)_rout2,
	                 (uint64_t *)_rout3));
...
static __inline int
_skel_method_4(int (*_pfn)(uint64_t, int64_t), uint32_t _sc, remote_arg *_pra)
{
	remote_arg *_praEnd = 0;
	uint64_t _in0[1] = { 0 };
	uint64_t _in1[1] = { 0 };
...
static __inline int
_skel_method_5(int (*_pfn)(int, uint32_t, uint32_t, uint64_t, int64_t,
                           uint64_t *, uint64_t *),
               uint32_t _sc, remote_arg *_pra)
{
	...
	_TRY(_nErr, _pfn((int)*_in0, (uint32_t)*_in1, (uint32_t)*_in2,
	                 (uint64_t)*_in3, (int64_t)*_in4, (uint64_t *)_rout5,
	                 (uint64_t *)_rout6));
...
static __inline int
_skel_method_6(int (*_pfn)(uint32_t, int32_t), uint32_t _sc, remote_arg *_pra)
{
	remote_arg *_praEnd = 0;
	uint32_t _in0[1] = { 0 };
	uint32_t _in1[1] = { 0 };
...
static __inline int
_skel_method_7(int (*_pfn)(int, uint32_t, uint32_t, uint32_t, int32_t,
                           uint32_t *, uint32_t *),
               uint32_t _sc, remote_arg *_pra)
{
	remote_arg *_praEnd = 0;
	...
	_TRY(_nErr, _pfn((int)*_in0, (uint32_t)*_in1, (uint32_t)*_in2,
	                 (uint32_t)*_in3, (int32_t)*_in4, (uint32_t *)_rout5,
	                 (uint32_t *)_rout6));
                                  ...
                                  remote_arg *_pra) __QAIC_SKEL_ATTRIBUTE
{
	...
	case 0:
		return _skel_method_7(__QAIC_IMPL(apps_mem_request_map), _sc,
		                      _pra);
	case 1:
		return _skel_method_6(__QAIC_IMPL(apps_mem_request_unmap), _sc,
		                      _pra);
	case 2:
		return _skel_method_5(__QAIC_IMPL(apps_mem_request_map64), _sc,
		                      _pra);
	case 3:
		return _skel_method_4(__QAIC_IMPL(apps_mem_request_unmap64),
		                      _sc, _pra);
	case 4:
		return _skel_method_3(__QAIC_IMPL(apps_mem_share_map), _sc,
		                      _pra);
	case 5:
		return _skel_method_2(__QAIC_IMPL(apps_mem_share_unmap), _sc,
		                      _pra);
	case 6:
		return _skel_method_1(__QAIC_IMPL(apps_mem_dma_handle_map),
		                      _sc, _pra);
	case 7:
		return _skel_method(__QAIC_IMPL(apps_mem_dma_handle_unmap),
		                    _sc, _pra);
	}
