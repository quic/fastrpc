...
static const Parameter *const parameterArrays[23] = {
    ...
    (&(parameters[6])), (&(parameters[0])), (&(parameters[1])),
    (&(parameters[1])), (&(parameters[1])), (&(parameters[2])),
    (&(parameters[3])), (&(parameters[3])), (&(parameters[0])),
    (&(parameters[0])), (&(parameters[6])), (&(parameters[6])),
    (&(parameters[0])), (&(parameters[0])), (&(parameters[0])),
    (&(parameters[4])), (&(parameters[0]))};
static const Method methods[8] = {
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x1, 0x0, 0x0), 0x14, 0x8, 7, 7,
     (&(parameterArrays[7])), 0x4, 0x4},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x0, 0x0, 0x0), 0x8, 0x0, 2, 2,
     (&(parameterArrays[10])), 0x4, 0x0},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x1, 0x0, 0x0), 0x20, 0x10, 11, 7,
     (&(parameterArrays[0])), 0x8, 0x8},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x0, 0x0, 0x0), 0x10, 0x0, 6, 2,
     (&(parameterArrays[3])), 0x8, 0x0},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x1, 0x0, 0x0), 0x8, 0x10, 4, 4,
     (&(parameterArrays[14])), 0x4, 0x8},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x0, 0x0, 0x0), 0xc, 0x0, 4, 2,
     (&(parameterArrays[21])), 0x8, 0x0},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x0, 0x0, 0x0), 0xc, 0x0, 3, 3,
     (&(parameterArrays[18])), 0x4, 0x0},
    {REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x0, 0x0, 0x0), 0x8, 0x0, 2, 2,
     (&(parameterArrays[14])), 0x4, 0x0}};
static const Method *const methodArrays[8] = {
    &(methods[0]), &(methods[1]), &(methods[2]), &(methods[3]),
    &(methods[4]), &(methods[5]), &(methods[6]), &(methods[7])};
static const char strings[170] =
    "dma_handle_unmap\0request_unmap64\0dma_handle_map\0request_map64\0request_"
    "unmap\0share_unmap\0request_map\0share_map\0ion_"
    "flags\0offset\0rflags\0heapid\0vadsp\0vapps\0size\0len\0vin\0fd\0";
static const uint16_t methodStrings[37] = {
    48,  134, 110, 127, 162, 158, 147, 141, 88, 134, 110, 127, 162,
    158, 147, 141, 100, 166, 153, 147, 141, 33, 166, 120, 153, 0,
    166, 153, 76,  141, 153, 17,  141, 158, 62, 141, 158};
static const uint16_t methodStringsArrays[8] = {8, 34, 0, 31, 16, 28, 21, 25};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(apps_mem_slim) = {
    8,      &(methodArrays[0]), 0, 0, &(methodStringsArrays[0]), methodStrings,
    strings};
...
extern "C" {
#endif
_ATTRIBUTE_VISIBILITY uint32_t apps_mem_skel_invoke_qaic_version = 10042;
static __inline int _skel_method(int (*_pfn)(int, int), uint32_t _sc,
                                 remote_arg *_pra) {
  ...
  _TRY(_nErr, _pfn((int)*_in0, (int)*_in1));
  _CATCH(_nErr) {}
  return _nErr;
}
static __inline int _skel_method_1(int (*_pfn)(int, int, int), uint32_t _sc,
                                   remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  uint32_t _in1[1] = {0};
  ...
  _TRY(_nErr, _pfn((int)*_in0, (int)*_in1, (int)*_in2));
  _CATCH(_nErr) {}
  return _nErr;
}
static __inline int _skel_method_2(int (*_pfn)(uint64, int), uint32_t _sc,
                                   remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint64_t _in0[1] = {0};
  uint32_t _in1[1] = {0};
...
static __inline int _skel_method_3(int (*_pfn)(int, int, uint64 *, uint64 *),
...
static __inline int _skel_method_4(int (*_pfn)(uint64, int64), uint32_t _sc,
                                   remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint64_t _in0[1] = {0};
  uint64_t _in1[1] = {0};
...
static __inline int _skel_method_5(int (*_pfn)(int, uint32, uint32, uint64,
                                               int64, uint64 *, uint64 *),
                                   uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  ...
  _TRY(_nErr, _pfn((int)*_in0, (uint32)*_in1, (uint32)*_in2, (uint64)*_in3,
                   (int64)*_in4, (uint64 *)_rout5, (uint64 *)_rout6));
  _COPY(_primROut, 0, _rout5, 0, 8);
  _COPY(_primROut, 8, _rout6, 0, 8);
  _CATCH(_nErr) {}
  return _nErr;
}
static __inline int _skel_method_6(int (*_pfn)(uint32, int32), uint32_t _sc,
                                   remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  uint32_t _in1[1] = {0};
...
static __inline int _skel_method_7(int (*_pfn)(int, uint32, uint32, uint32,
                                               int32, uint32 *, uint32 *),
                                   uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  ...
  _TRY(_nErr, _pfn((int)*_in0, (uint32)*_in1, (uint32)*_in2, (uint32)*_in3,
                   (int32)*_in4, (uint32 *)_rout5, (uint32 *)_rout6));
...
__QAIC_SKEL(apps_mem_skel_invoke)(uint32_t _sc,
                                  remote_arg *_pra) __QAIC_SKEL_ATTRIBUTE {
  switch (REMOTE_SCALARS_METHOD(_sc)) {
  case 0:
    return _skel_method_7(__QAIC_IMPL(apps_mem_request_map), _sc, _pra);
  case 1:
    return _skel_method_6(__QAIC_IMPL(apps_mem_request_unmap), _sc, _pra);
  case 2:
    return _skel_method_5(__QAIC_IMPL(apps_mem_request_map64), _sc, _pra);
  case 3:
    return _skel_method_4(__QAIC_IMPL(apps_mem_request_unmap64), _sc, _pra);
  case 4:
    return _skel_method_3(__QAIC_IMPL(apps_mem_share_map), _sc, _pra);
  case 5:
    return _skel_method_2(__QAIC_IMPL(apps_mem_share_unmap), _sc, _pra);
  case 6:
    return _skel_method_1(__QAIC_IMPL(apps_mem_dma_handle_map), _sc, _pra);
  case 7:
    return _skel_method(__QAIC_IMPL(apps_mem_dma_handle_unmap), _sc, _pra);
  }
