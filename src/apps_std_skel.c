...
static const Type types[8] = {
    ...
    {0xff, {{(const uintptr_t) & (types[5]), (const uintptr_t)0xff}}, 8, 0x1},
    {0x1, {{(const uintptr_t)0, (const uintptr_t)1}}, 2, 0x1},
    {0x4, {{(const uintptr_t)0, (const uintptr_t)1}}, 2, 0x4},
    {0x8, {{(const uintptr_t)0, (const uintptr_t)1}}, 2, 0x8}};
...
static const char strings[568] =
    "get_search_paths_with_env\0fopen_with_env_fd\0fdopen_decrypt\0fopen_with_"
    "env\0print_"
    "string\0bytesWritten\0fileExists\0maxPathLen\0envvarname\0fclose_"
    "fd\0ctimensec\0mtimensec\0atimensec\0valLenReq\0posLenReq\0bytesRead\0fope"
    "n_"
    "fd\0closedir\0numPaths\0unsetenv\0override\0clearerr\0newname\0oldname\0fr"
    "ename\0readdir\0opendir\0fremove\0fsetpos\0fgetpos\0freopen\0ftrunc\0diren"
    "t\0handle\0exists\0getenv\0ferror\0rewind\0whence\0offset\0fwrite\0fclose"
    "\0fflush\0ctime\0mtime\0atime\0nlink\0rmdir\0mkdir\0fsync\0paths\0fgets\0d"
    "elim\0fseek\0ftell\0fread\0psout\0fopen\0size\0rdev\0stat\0path\0feof\0fle"
    "n\0bEOF\0mode\0tsz\0ino\0val\0str\0buf\0sin\0";
static const uint16_t methodStrings[143] = {
    513, 128, 513, 543, 509, 547, 538, 431, 508, 503, 425, 163, 419, 153, 413,
    143, 26,  122, 467, 128, 538, 41,  529, 281, 217, 343, 336, 547, 128, 533,
    0,   122, 467, 455, 221, 111, 59,  122, 467, 128, 538, 491, 203, 128, 538,
    41,  529, 392, 563, 559, 87,  533, 485, 563, 559, 193, 533, 321, 563, 128,
    538, 491, 289, 128, 217, 343, 461, 563, 559, 533, 232, 128, 551, 239, 357,
    128, 551, 173, 473, 563, 385, 378, 313, 563, 309, 183, 497, 128, 538, 491,
    273, 265, 257, 329, 563, 385, 443, 128, 538, 212, 217, 343, 44,  563, 491,
    100, 518, 350, 364, 563, 253, 523, 563, 533, 528, 563, 529, 479, 563, 309,
    305, 563, 309, 133, 41,  437, 128, 297, 128, 449, 563, 230, 128, 74,  555,
    248, 563, 371, 563, 399, 563, 406, 563};
...
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(apps_std_slim) = {
    37,     &(methodArrays[0]), 0, 0, &(methodStringsArrays[0]), methodStrings,
    strings};
...
static __inline int _skel_method(int (*_pfn)(const char *, const char *,
  ...
  _TRY(_nErr,
       _pfn((const char *)*_in1, (const char *)*_in2, (const char *)*_in3,
            (const char *)*_in4, (int *)_rout5, (int *)_rout6));
  _COPY(_primROut, 0, _rout5, 0, 4);
  _COPY(_primROut, 4, _rout6, 0, 4);
  _CATCH(_nErr) {}
  return _nErr;
}
static __inline int _skel_method_1(int (*_pfn)(int), uint32_t _sc,
                                   remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  uint32_t _in1[1] = {0};
...
static __inline int _skel_method_2(int (*_pfn)(const char *, const char *,
                                               int *, int *),
                                   uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  ...
  _in2[0] = _praIn[1].buf.pv;
  _ASSERT(_nErr, (_in2Len[0] > 0) && (_in2[0][(_in2Len[0] - 1)] == 0));
  _TRY(_nErr, _pfn((const char *)*_in1, (const char *)*_in2, (int *)_rout3,
                   (int *)_rout4));
...
static __inline int _skel_method_3(int (*_pfn)(const char *, const char *),
                                   uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  char *_in1[1] = {0};
...
static __inline int _skel_method_4(int (*_pfn)(apps_std_FILE, int),
                                   uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  uint32_t _in1[1] = {0};
...
static __inline int _skel_method_5(int (*_pfn)(const char *, apps_std_STAT *),
                                   uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  char *_in1[1] = {0};
...
static __inline int _skel_invoke(uint32_t _mid, uint32_t _sc,
                                 remote_arg *_pra) {
  switch (_mid) {
  case 31:
...
static __inline int _skel_method_6(int (*_pfn)(const char *), uint32_t _sc,
                                   remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  char *_in0[1] = {0};
...
static __inline int _skel_method_7(int (*_pfn)(const char *, int), uint32_t _sc,
                                   remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  char *_in0[1] = {0};
  uint32_t _in0Len[1] = {0};
...
static __inline int _skel_method_8(int (*_pfn)(const apps_std_DIR *,
                                               apps_std_DIRENT *, int *),
                                   uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint64_t _in0[1] = {0};
...
static __inline int _skel_method_9(int (*_pfn)(const apps_std_DIR *),
                                   uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint64_t _in0[1] = {0};
  uint64_t *_primIn = 0;
...
static __inline int _skel_method_10(int (*_pfn)(const char *, apps_std_DIR *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  char *_in0[1] = {0};
  uint32_t _in0Len[1] = {0};
...
static __inline int _skel_method_11(int (*_pfn)(apps_std_FILE, apps_std_FILE *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  uint32_t _rout1[1] = {0};
...
static __inline int _skel_method_12(int (*_pfn)(apps_std_FILE), uint32_t _sc,
                                    remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  uint32_t *_primIn = 0;
...
static __inline int _skel_method_13(int (*_pfn)(const char *, boolean *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  char *_in0[1] = {0};
  uint32_t _in0Len[1] = {0};
...
static __inline int _skel_pack(_ATTRIBUTE_UNUSED remote_arg *_praROutPost,
...
static __inline int _skel_unpack(_ATTRIBUTE_UNUSED _allocator *_al,
...
static __inline int _skel_method_14(int (*_pfn)(const char *, const char *,
                                                _cstring1_t *, int, uint32 *,
                                                uint16 *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  char *_in0[1] = {0};
  ...
  for (_ii = 0, _seq_primIn2 = (char *)_praIn[2].buf.pv,
    ...
    _TRY(_nErr,
         _skel_unpack(_al, (_praIn + 3), _ppraIn, (_praROut + 0), _ppraROut,
  ...
  _TRY(_nErr,
       _pfn((const char *)*_in0, (const char *)*_in1, (_cstring1_t *)*_rout2,
            (int)*_rout2Len, (uint32 *)_rout3, (uint16 *)_rout4));
  for (_ii = 0, _seq_nat2 = (char *)_rout2[0]; _ii < (int)_rout2Len[0];
       ++_ii, _seq_nat2 = (_seq_nat2 + SLIM_IFPTR32(8, 16))) {
    _TRY(_nErr,
         _skel_pack((_praROutPost + 0), _ppraROutPost, 0,
                    SLIM_IFPTR32((char **)&(((uint32_t *)_seq_nat2)[0]),
                                 (char **)&(((uint64_t *)_seq_nat2)[0])),
                    SLIM_IFPTR32((uint32_t *)&(((uint32_t *)_seq_nat2)[1]),
                                 (uint32_t *)&(((uint32_t *)_seq_nat2)[2]))));
...
static __inline int _skel_method_15(int (*_pfn)(apps_std_FILE, byte *, int,
                                                int *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  ...
  _TRY(_nErr, _pfn((apps_std_FILE)*_in0, (byte *)*_rout1, (int)*_rout1Len,
                   (int *)_rout2));
  _COPY(_primROut, 0, _rout2, 0, 4);
  _CATCH(_nErr) {}
  return _nErr;
}
static __inline int _skel_method_16(int (*_pfn)(const char *, const char *,
  ...
  _ASSERT(_nErr, (_in3Len[0] > 0) && (_in3[0][(_in3Len[0] - 1)] == 0));
  _TRY(_nErr,
       _pfn((const char *)*_in0, (const char *)*_in1, (const char *)*_in2,
            (const char *)*_in3, (apps_std_FILE *)_rout4));
  _COPY(_primROut, 0, _rout4, 0, 4);
  _CATCH(_nErr) {}
  return _nErr;
}
static __inline int _skel_method_17(int (*_pfn)(const char *, const char *,
                                                int),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  char *_in0[1] = {0};
...
static __inline int _skel_method_18(int (*_pfn)(const char *, char *, int,
                                                int *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  char *_in0[1] = {0};
...
static __inline int _skel_method_19(int (*_pfn)(apps_std_FILE, int *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  uint32_t _rout1[1] = {0};
...
static __inline int _skel_method_20(int (*_pfn)(apps_std_FILE, uint64 *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  uint64_t _rout1[1] = {0};
...
static __inline int _skel_method_21(int (*_pfn)(apps_std_FILE, int,
                                                apps_std_SEEK),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
...
static __inline int _skel_method_22(int (*_pfn)(apps_std_FILE, const byte *,
                                                int),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
...
static __inline int _skel_method_23(int (*_pfn)(apps_std_FILE, const byte *,
                                                int, int *, int *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
  ...
  _in1[0] = _praIn[0].buf.pv;
  _TRY(_nErr, _pfn((apps_std_FILE)*_in0, (const byte *)*_in1, (int)*_in1Len,
                   (int *)_rout2, (int *)_rout3));
  _COPY(_primROut, 0, _rout2, 0, 4);
  _COPY(_primROut, 4, _rout3, 0, 4);
  _CATCH(_nErr) {}
  return _nErr;
}
static __inline int _skel_method_24(int (*_pfn)(apps_std_FILE, byte *, int,
                                                int *, int *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  uint32_t _in0[1] = {0};
...
static __inline int _skel_method_25(int (*_pfn)(apps_std_FILE, const char *,
...
static __inline int _skel_method_26(int (*_pfn)(const char *, const char *,
                                                apps_std_FILE *),
                                    uint32_t _sc, remote_arg *_pra) {
  remote_arg *_praEnd = 0;
  char *_in0[1] = {0};
  ...
  _ASSERT(_nErr, (_in1Len[0] > 0) && (_in1[0][(_in1Len[0] - 1)] == 0));
  _TRY(_nErr,
       _pfn((const char *)*_in0, (const char *)*_in1, (apps_std_FILE *)_rout2));
  _COPY(_primROut, 0, _rout2, 0, 4);
  _CATCH(_nErr) {}
  return _nErr;
}
...
__QAIC_SKEL(apps_std_skel_invoke)(uint32_t _sc,
  ...
  case 21:
    return _skel_method_14(__QAIC_IMPL(apps_std_get_search_paths_with_env), _sc,
                           _pra);
  case 22:
