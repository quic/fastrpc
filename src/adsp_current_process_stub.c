...
static const Parameter parameters[4] = {{0x2,{{(const uintptr_t)0,(const uintptr_t)1}}, 2,0x2,0,0},{SLIM_IFPTR32(0x8,0x10),{{(const uintptr_t)&(sequenceTypes[0]),0}}, 25,SLIM_IFPTR32(0x4,0x8),0,0},{0x4,{{(const uintptr_t)0,(const uintptr_t)1}}, 2,0x4,3,0},{0x4,{{(const uintptr_t)0,(const uintptr_t)1}}, 2,0x4,0,0}};
static const Parameter* const parameterArrays[7] = {(&(parameters[3])),(&(parameters[3])),(&(parameters[3])),(&(parameters[1])),(&(parameters[0])),(&(parameters[1])),(&(parameters[2]))};
...
static const Method* const methodArrays[9] = {&(methods[0]),&(methods[0]),&(methods[1]),&(methods[2]),&(methods[3]),&(methods[0]),&(methods[4]),&(methods[5]),&(methods[0])};
static const char strings[152] = "enable_notifications\0set_logging_params2\0set_logging_params\0thread_exit\0filesToLog\0poll_mode\0exception\0timeout\0latency\0getASID\0enable\0setQoS\0asid\0mask\0";
static const uint16_t methodStrings[17] = {83,127,103,21,146,72,41,146,72,134,111,119,141,0,93,60,67};
static const uint16_t methodStringsArrays[9] = {16,15,6,11,9,14,3,0,13};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(adsp_current_process_slim) = {9,&(methodArrays[0]),0,0,&(methodStringsArrays [0]),methodStrings,strings};
...
static __inline int _stub_method_3(remote_handle _handle, uint32_t _mid, uint32_t _in0[1]) {
   remote_arg _pra[1] = {0};
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_setQoS)(unsigned int latency) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 4;
   remote_handle _handle = _adsp_current_process_handle();
   if (_handle != (remote_handle)-1)
   {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_exception)(void) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 5;
   remote_handle _handle = _adsp_current_process_handle();
   if (_handle != (remote_handle)-1)
   {
...
static __inline int _stub_method_4(remote_handle _handle, uint32_t _mid, uint32_t _in0[1], void* _in1[1], uint32_t _in1Len[1]) {
   remote_arg* _pra = 0;
   int _numIn[1] = {0};
   int _numROut[1] = {0};
   int _numInH[1] = {0};
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_set_logging_params2)(unsigned int mask, const _cstring1_t* filesToLog, int filesToLogLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 6;
   remote_handle _handle = _adsp_current_process_handle();
   if (_handle != (remote_handle)-1)
   {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_poll_mode)(unsigned int enable, unsigned int timeout) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 7;
   remote_handle _handle = _adsp_current_process_handle();
   if (_handle != (remote_handle)-1)
   {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_enable_notifications)(void) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 8;
   remote_handle _handle = _adsp_current_process_handle();
   if (_handle != (remote_handle)-1)
   {
