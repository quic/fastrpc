...
static const Method *const methodArrays[9] = {
    &(methods[0]), &(methods[0]), &(methods[1]), &(methods[2]), &(methods[3]),
    &(methods[0]), &(methods[4]), &(methods[5]), &(methods[0])};
static const char strings[152] =
    ...
    "mode\0exception\0timeout\0latency\0getASID\0enable\0setQoS\0asid\0mask\0";
static const uint16_t methodStrings[17] = {
    83, 127, 103, 21, 146, 72, 41, 146, 72, 134, 111, 119, 141, 0, 93, 60, 67};
...
__QAIC_STUB_EXPORT remote_handle _adsp_current_process_handle(void) {
  ...
  if (adsp_pls_add_lookup) {
    ...
    if (0 == HAP_pls_add_lookup((uint32_t)_adsp_current_process_handle, 0,
                                sizeof(*ph), _adsp_current_process_pls_ctor,
                                "adsp_current_process",
                                _adsp_current_process_pls_dtor, (void **)&ph)) {
      return *ph;
    }
    return (remote_handle)-1;
...
__QAIC_STUB_EXPORT remote_handle _adsp_current_process_handle(void) {
  ...
  if ((remote_handle)-1 != handle) {
    ...
    remote_handle tmp;
    int nErr =
        _adsp_current_process_pls_ctor("adsp_current_process", (void *)&tmp);
    if (nErr) {
      return (remote_handle)-1;
    }
    if (((remote_handle)-1 != handle) ||
        ((remote_handle)-1 !=
         (remote_handle)_adsp_current_process_atomic_CompareAndExchange(
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_set_logging_params)(
  ...
  if (_handle != (remote_handle)-1) {
    return _stub_method_1(_handle, _mid, (uint16_t *)&mask,
                          (void **)&filesToLog, (uint32_t *)&filesToLogLen);
  } else {
    return AEE_EINVHANDLE;
  }
}
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_getASID)(
    unsigned int *asid) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 3;
  remote_handle _handle = _adsp_current_process_handle();
  if (_handle != (remote_handle)-1) {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_setQoS)(
    unsigned int latency) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 4;
  remote_handle _handle = _adsp_current_process_handle();
  if (_handle != (remote_handle)-1) {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_set_logging_params2)(
...
static __inline int _stub_method_5(remote_handle _handle, uint32_t _mid,
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_poll_mode)(
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_enable_notifications)(
    void) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 8;
  remote_handle _handle = _adsp_current_process_handle();
  if (_handle != (remote_handle)-1) {
    return _stub_method(_handle, _mid);
