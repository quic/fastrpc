...
__QAIC_STUB_EXPORT remote_handle _adsp_perf_handle(void) {
  ...
  if (adsp_pls_add_lookup) {
    if (0 == adsp_pls_add_lookup((uint32_t)_adsp_perf_handle, 0, sizeof(*ph),
                                 _adsp_perf_pls_ctor, "adsp_perf",
                                 _adsp_perf_pls_dtor, (void **)&ph)) {
      return *ph;
    }
    return (remote_handle)-1;
  } else if (HAP_pls_add_lookup) {
    if (0 == HAP_pls_add_lookup((uint32_t)_adsp_perf_handle, 0, sizeof(*ph),
                                _adsp_perf_pls_ctor, "adsp_perf",
                                _adsp_perf_pls_dtor, (void **)&ph)) {
      return *ph;
    }
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_perf_get_usecs)(int64 *dst, int dstLen) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 1;
  remote_handle _handle = _adsp_perf_handle();
  if (_handle != (remote_handle)-1) {
