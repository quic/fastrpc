...
static const Parameter *const parameterArrays[5]
    = { (&(parameters[2])), (&(parameters[3])), (&(parameters[3])),
...
static const char strings[49]
    = "get_usecs\0get_keys\0numKeys\0maxLen\0enable\0dst\0ix\0";
static const uint16_t methodStrings[8] = { 10, 14, 27, 19, 0, 41, 34, 45 };
static const uint16_t methodStringsArrays[3] = { 6, 4, 0 };
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(adsp_perf_slim)
    = { 3,      &(methodArrays[0]),        0,
...
static int
_adsp_perf_pls_ctor(void *ctx, void *data)
{
	remote_handle *ph = (remote_handle *)data;
	*ph = _const_adsp_perf_handle;
...
_adsp_perf_handle(void)
{
	remote_handle *ph = 0;
	if(adsp_pls_add_lookup) {
		if(0
		   == adsp_pls_add_lookup((uint32_t)_adsp_perf_handle, 0,
		                          sizeof(*ph), _adsp_perf_pls_ctor,
		                          "adsp_perf", _adsp_perf_pls_dtor,
		                          (void **)&ph)) {
			return *ph;
		}
		...
		if(0
		   == HAP_pls_add_lookup((uint32_t)_adsp_perf_handle, 0,
		                         sizeof(*ph), _adsp_perf_pls_ctor,
		                         "adsp_perf", _adsp_perf_pls_dtor,
		                         (void **)&ph)) {
			return *ph;
...
uint32_t _adsp_perf_atomic_CompareAndExchange(uint32_t *volatile puDest,
                                              uint32_t uExchange,
                                              uint32_t uCompare);
...
#endif //_USRDLL
uint32_t
_adsp_perf_atomic_CompareAndExchange(uint32_t *volatile puDest,
...
_adsp_perf_handle(void)
{
	...
	if((remote_handle)-1 != handle) {
		...
		if(((remote_handle)-1 != handle)
		   || ((remote_handle)-1
		       != (remote_handle)_adsp_perf_atomic_CompareAndExchange(
...
__QAIC_STUB(adsp_perf_enable)(int ix) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 0;
	remote_handle _handle = _adsp_perf_handle();
...
static __inline int
_stub_method_1(remote_handle _handle, uint32_t _mid, char *_rout0[1],
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_perf_get_usecs)(int64_t *dst,
                                 int dstLen) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 1;
	remote_handle _handle = _adsp_perf_handle();
	if(_handle != (remote_handle)-1) {
		return _stub_method_1(_handle, _mid, (char **)&dst,
		                      (uint32_t *)&dstLen);
	} else {
		return AEE_EINVHANDLE;
	}
...
static __inline int
_stub_method_2(remote_handle _handle, uint32_t _mid, char *_rout0[1],
               uint32_t _rout0Len[1], uint32_t _rout1[1], uint32_t _rout2[1])
{
	int _numIn[1] = { 0 };
	remote_arg _pra[3] = { 0 };
	uint32_t _primIn[1] = { 0 };
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adsp_perf_get_keys)(char *keys, int keysLen, int *maxLen,
                                int *numKeys) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 2;
	remote_handle _handle = _adsp_perf_handle();
	if(_handle != (remote_handle)-1) {
		return _stub_method_2(_handle, _mid, (char **)&keys,
		                      (uint32_t *)&keysLen, (uint32_t *)maxLen,
		                      (uint32_t *)numKeys);
	} else {
		return AEE_EINVHANDLE;
	}
