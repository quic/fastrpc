...
static const Parameter *const parameterArrays[8]
	...
	(&(parameters[5])), (&(parameters[6])), (&(parameters[0])),
...
static const Method methods[5]
	...
	{ REMOTE_SCALARS_MAKEX(0, 0, 0x0, 0x0, 0x0, 0x0), 0x0, 0x0, 0, 0, 0,
	  0x0, 0x0 },
	{ REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x1, 0x0, 0x0), 0x18, 0x8, 7, 5,
	  (&(parameterArrays[0])), 0x8, 0x8 },
	{ REMOTE_SCALARS_MAKEX(0, 0, 0x0, 0x1, 0x0, 0x0), 0x0, 0x8, 1, 1,
	  (&(parameterArrays[4])), 0x1, 0x8 } };
static const Method *const methodArrays[6]
    = { &(methods[0]), &(methods[1]), &(methods[2]),
	&(methods[2]), &(methods[3]), &(methods[4]) };
static const char strings[99] = "bytes_to_read\0buff_addr\0ion_flags\0buf_"
				"size\0filter\0heapid\0deinit\0init3\0init2\0c"
				"lose\0wait\0open\0uri\0h\0";
static const uint16_t methodStrings[15]
    = { 64, 50, 24, 43, 34, 14, 87, 92, 96, 82, 0, 76, 96, 57, 70 };
static const uint16_t methodStringsArrays[6] = { 6, 11, 14, 13, 0, 9 };
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(adspmsgd_adsp1_slim)
    = { 6,      &(methodArrays[0]),        0,
...
__QAIC_STUB(adspmsgd_adsp1_open)(const char *uri,
                                 remote_handle64 *h) __QAIC_STUB_ATTRIBUTE
{
	return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int
__QAIC_STUB(adspmsgd_adsp1_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE
{
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adspmsgd_adsp1_init2)(remote_handle64 _handle)
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adspmsgd_adsp1_deinit)(remote_handle64 _handle)
    __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 3;
	return _stub_method(_handle, _mid);
...
_stub_method_1(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1],
               uint32_t _in1[1], uint32_t _in2[1], uint64_t _in3[1],
               uint64_t _rout4[1])
{
	int _numIn[1] = { 0 };
	remote_arg _pra[2] = { 0 };
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adspmsgd_adsp1_init3)(remote_handle64 _handle, int heapid,
                                  uint32_t ion_flags, uint32_t filter,
                                  uint64_t buf_size,
                                  uint64_t *buff_addr) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 4;
	return _stub_method_1(_handle, _mid, (uint32_t *)&heapid,
	                      (uint32_t *)&ion_flags, (uint32_t *)&filter,
	                      (uint64_t *)&buf_size, (uint64_t *)buff_addr);
}
static __inline int
_stub_method_2(remote_handle64 _handle, uint32_t _mid, uint64_t _rout0[1])
{
	int _numIn[1] = { 0 };
	remote_arg _pra[1] = { 0 };
	uint64_t _primROut[1] = { 0 };
...
__QAIC_STUB_EXPORT int
__QAIC_STUB(adspmsgd_adsp1_wait)(remote_handle64 _handle,
                                 uint64_t *bytes_to_read) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 5;
