...
static const Method *const methodArrays[6] = {&(methods[0]), &(methods[1]),
                                              &(methods[2]), &(methods[2]),
                                              &(methods[3]), &(methods[4])};
static const char strings[99] =
    "bytes_to_read\0buff_addr\0ion_flags\0buf_"
    "size\0filter\0heapid\0deinit\0init3\0init2\0close\0wait\0open\0uri\0h\0";
static const uint16_t methodStrings[15] = {64, 50, 24, 43, 34, 14, 87, 92,
                                           96, 82, 0,  76, 96, 57, 70};
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adspmsgd_adsp1_init2)(
    remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 2;
  return _stub_method(_handle, _mid);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(adspmsgd_adsp1_deinit)(
    remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 3;
  return _stub_method(_handle, _mid);
}
static __inline int _stub_method_1(remote_handle64 _handle, uint32_t _mid,
                                   ...
                                   uint32_t _in2[1], uint64_t _in3[1],
                                   uint64_t _rout4[1]) {
  int _numIn[1] = {0};
  remote_arg _pra[2] = {0};
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adspmsgd_adsp1_init3)(
    remote_handle64 _handle, int heapid, uint32 ion_flags, uint32 filter,
    uint64 buf_size, uint64 *buff_addr) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 4;
...
__QAIC_STUB(adspmsgd_adsp1_wait)(remote_handle64 _handle,
                                 uint64 *bytes_to_read) __QAIC_STUB_ATTRIBUTE {
  uint32_t _mid = 5;
