...
uint32 atomic_CompareAndExchange(uint32 *volatile puDest, uint32 uExchange,
  ...
  return (uint32)InterlockedCompareExchange((LONG *)puDest, (LONG)uExchange,
                                            (LONG)uCompare);
}
uintptr_t atomic_CompareAndExchangeUP(uintptr_t *volatile puDest,
  ...
  return (uintptr_t)InterlockedCompareExchangePointer(
      (void **)puDest, (void *)uExchange, (void *)uCompare);
}
#elif __hexagon__
...
qurt_atomic_compare_val_and_set(unsigned int *target, unsigned int old_val,
...
uint32 atomic_CompareAndExchange(uint32 *volatile puDest, uint32 uExchange,
                                 uint32 uCompare) {
  return (uint32)qurt_atomic_compare_val_and_set((unsigned int *)puDest,
                                                 uCompare, uExchange);
}
uintptr_t atomic_CompareAndExchangeUP(uintptr_t *volatile puDest,
                                      uintptr_t uExchange, uintptr_t uCompare) {
  C_ASSERT(sizeof(uintptr_t) == sizeof(uint32));
  return (uint32)atomic_CompareAndExchange((uint32 *)puDest, (uint32)uExchange,
                                           (uint32)uCompare);
}
#elif __GNUC__
uint32 atomic_CompareAndExchange(uint32 *volatile puDest, uint32 uExchange,
