...
static const Type types[2] = {{0x8,{{(const uintptr_t)0,(const uintptr_t)1}}, 2,0x8},{0x1,{{(const uintptr_t)0,(const uintptr_t)1}}, 2,0x1}};
...
static const Parameter* const parameterArrays[8] = {(&(parameters[5])),(&(parameters[6])),(&(parameters[6])),(&(parameters[0])),(&(parameters[1])),(&(parameters[4])),(&(parameters[3])),(&(parameters[2]))};
static const Method methods[5] = {{REMOTE_SCALARS_MAKEX(0,0,0x2,0x0,0x0,0x1),0x4,0x0,2,2,(&(parameterArrays[3])),0x4,0x1},{REMOTE_SCALARS_MAKEX(0,0,0x0,0x0,0x1,0x0),0x0,0x0,1,1,(&(parameterArrays[7])),0x1,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x0,0x0,0x0),0x4,0x0,1,1,(&(parameterArrays[6])),0x4,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x1,0x0,0x0),0x4,0x0,3,1,(&(parameterArrays[5])),0x4,0x1},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x2,0x0,0x0),0x4,0x8,5,3,(&(parameterArrays[0])),0x4,0x4}};
static const Method* const methodArrays[5] = {&(methods[0]),&(methods[1]),&(methods[2]),&(methods[3]),&(methods[4])};
static const char strings[66] = "get_usecs\0get_keys\0numKeys\0maxLen\0enable\0close\0open\0dst\0uri\0ix\0h\0";
static const uint16_t methodStrings[13] = {10,14,27,19,47,56,63,0,52,34,60,41,63};
static const uint16_t methodStringsArrays[5] = {4,11,9,7,0};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(adsp_perf1_slim) = {5,&(methodArrays[0]),0,0,&(methodStringsArrays [0]),methodStrings,strings};
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_perf1_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_perf1_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_perf1_enable)(remote_handle64 _handle, int ix) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_perf1_get_usecs)(remote_handle64 _handle, int64_t* dst, int dstLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 3;
   return _stub_method_1(_handle, _mid, (char**)&dst, (uint32_t*)&dstLen);
}
static __inline int _stub_method_2(remote_handle64 _handle, uint32_t _mid, char* _rout0[1], uint32_t _rout0Len[1], uint32_t _rout1[1], uint32_t _rout2[1]) {
   int _numIn[1] = {0};
   remote_arg _pra[3] = {0};
   uint32_t _primIn[1]= {0};
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_perf1_get_keys)(remote_handle64 _handle, char* keys, int keysLen, int* maxLen, int* numKeys) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 4;
   return _stub_method_2(_handle, _mid, (char**)&keys, (uint32_t*)&keysLen, (uint32_t*)maxLen, (uint32_t*)numKeys);
}
#ifdef __cplusplus
}
#endif
