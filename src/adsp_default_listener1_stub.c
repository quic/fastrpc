...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_default_listener1_open)(
    const char *uri, remote_handle64 *h) __QAIC_STUB_ATTRIBUTE {
  return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_default_listener1_close)(
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_default_listener1_register)(
