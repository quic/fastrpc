...
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(adsp_default_listener1_slim) = {3,&(methodArrays[0]),0,0,&(methodStringsArrays [0]),methodStrings,strings};
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_default_listener1_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_default_listener1_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_default_listener1_register)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
