...
/**
 * The FARF_ERROR macro causes log messages to be compiled in when FARF_ERROR is
 * defined to 1
 */
#ifndef FARF_ERROR
#define FARF_ERROR 1
...
/**
 * The FARF_FATAL macro causes log messages to be compiled in when FARF_FATAL is
 * defined to 1
 */
#ifndef FARF_FATAL
#define FARF_FATAL 1
    ...
    if (0 == (HAP_debug_v2)) {                                                 \
      ...
      if (FARF_##x##_LEVEL & HAP_LEVEL_RUNTIME) {                              \
        if (0 != HAP_debug_runtime) {                                          \
          HAP_debug_runtime(FARF_##x##_LEVEL ^ HAP_LEVEL_RUNTIME,              \
