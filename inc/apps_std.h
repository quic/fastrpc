...
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_fopen)(const char *name, const char *mode,
 ...
 * @retval, if read or write return 0 for non zero length buffers, ferror is
 * checked and a non zero value is returned in case of error with no rout
 * parameters
 */
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_fread)(apps_std_FILE sin, byte *buf, int bufLen,
                                  int *bytesRead,
                                  int *bEOF) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_fwrite)(apps_std_FILE sin, const byte *buf,
 ...
 */
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_fgetpos)(apps_std_FILE sin, byte *pos, int posLen,
 ...
 */
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_fsetpos)(apps_std_FILE sin, const byte *pos,
...
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_fseek)(apps_std_FILE sin, int offset,
                                  apps_std_SEEK whence) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_flen)(apps_std_FILE sin,
                                 uint64 *len) __QAIC_HEADER_ATTRIBUTE;
/**
...
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_clearerr)(apps_std_FILE sin) __QAIC_HEADER_ATTRIBUTE;
...
/**
 * This function will try to open a file given directories in envvarname
 * separated by delim. so given environment variable FOO_PATH=/foo;/bar
...
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_fgets)(apps_std_FILE sin, byte *buf, int bufLen,
                                  int *bEOF) __QAIC_HEADER_ATTRIBUTE;
/**
...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(apps_std_get_search_paths_with_env)(
    ...
    uint32 *numPaths, uint16 *maxPathLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
...
/**
 * This function decrypts the file using the provided open file descriptor,
 * closes the original descriptor and return a new file descriptor.
 * @retval, if operation fails errno is returned
 */
...
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(apps_std_fopen_fd)(const char *name, const char *mode,
                                     int *fd, int *len) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
