 ...
 * @retval, 0 on success
 */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(dspqueue_rpc_open)(
...
/**
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(dspqueue_rpc_close)(remote_handle64 h)
    __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(dspqueue_rpc_init_process_state)(
    remote_handle64 _h, int32 process_state_fd) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(dspqueue_rpc_create_queue)(
    remote_handle64 _h, uint32 id, int32 queue_fd, uint32 count,
    uint64 *queue_id) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(dspqueue_rpc_destroy_queue)(
    remote_handle64 _h, uint64 queue_id) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(dspqueue_rpc_is_imported)(
    remote_handle64 _h, uint64 queue_id,
    int32 *imported) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(dspqueue_rpc_wait_signal)(
    remote_handle64 _h, int32 *signal) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(dspqueue_rpc_cancel_wait_signal)(
    remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(dspqueue_rpc_signal)(
    remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
#ifndef dspqueue_rpc_URI
#define dspqueue_rpc_URI                                                       \
  "file:///"                                                                   \
  "libdspqueue_rpc_skel.so?dspqueue_rpc_skel_handle_invoke&_modver=1.0"
