...
static __inline void QNode_CtorZ(QNode *me) { me->pNext = me->pPrev = 0; }

static __inline int QNode_IsQueuedZ(QNode *me) { return (0 != me->pNext); }
...
static __inline void QList_Ctor(QList *me) { QList_Zero(me); }

static __inline int QList_IsEmpty(QList *me) { return me->n.pNext == &me->n; }
