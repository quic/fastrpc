...
#ifndef _REMOTECTL1_H
#define _REMOTECTL1_H
#include <AEEStdDef.h>
#include <remote.h>
#include <string.h>
#include <stdlib.h>
...
#define _const_remotectl1_handle 8
/**
...
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(remotectl1_open)(const char *uri,
...
/**
    ...
    */
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(remotectl1_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(remotectl1_open1)(remote_handle64 _h, const char *name,
                                    int *handle, char *dlerror, int dlerrorLen,
                                    int *nErr) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(remotectl1_close1)(remote_handle64 _h, int handle,
                                     char *dlerror, int dlerrorLen,
                                     int *nErr) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(remotectl1_grow_heap)(remote_handle64 _h, uint32 phyAddr,
                                        uint32 nSize) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(remotectl1_set_param)(remote_handle64 _h, int reqID,
                                        const uint32 *params,
                                        int paramsLen) __QAIC_HEADER_ATTRIBUTE;
#ifndef remotectl1_URI
#define remotectl1_URI                                                         \
  "file:///libremotectl1_skel.so?remotectl1_skel_handle_invoke&_modver=1.0"
