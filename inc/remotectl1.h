...
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(remotectl1_close1)(remote_handle64 _h, int handle,
                                     ...
                                     int *nErr) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(remotectl1_grow_heap)(
    remote_handle64 _h, uint32_t phyAddr,
...
#define remotectl1_URI                                                        \
	"file:///"                                                            \
	"libremotectl1_skel.so?remotectl1_skel_handle_invoke&_modver=1.0"
