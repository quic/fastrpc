...
#define AEE_EINCOMPLETEITEM                                                    \
  (AEE_EOFFSET +                                                               \
   0x012) ///< Incomplete item, like length of a string is less that expected
...
#define AEE_EINVALIDITEM                                                       \
  (AEE_EOFFSET + 0x02A) ///< Current item is invalid, it can be a switch case or
                        ///< a pointer to memory
...
#define AEE_EINVHANDLE                                                         \
  (AEE_EOFFSET +                                                               \
   0x02C) ///< Invalid handle - adding here as its defined in vendor AEEStdErr.h
          ///< - needed to check valid handle in stub.c
...
#define AEE_EINVALIDDEVICE                                                     \
  (AEE_EOFFSET +                                                               \
   0x03B) ///<  Invalid Device or Device node open failed for the domain
...
#define AEE_ENOSUCHSYMBOL                                                      \
  (AEE_EOFFSET + 0x042) ///<  No such symbol( dlsym for the symbol failed)
...
#define AEE_EFOPEN                                                             \
  (AEE_EOFFSET +                                                               \
   0x057) ///<  file open error or device node open failed for DSP domain
...
#define AEE_PDRREGFAIL                                                         \
  (AEE_EOFFSET + 0x178) ///<  Error Callback Services Registration failed for PD
...
#define E_NO_MORE_FREE_SECTIONS                                                \
  (AEE_EOFFSET + 0x193) ///<  No more free sections available to grow heap
...
#define AEE_ESTUBSKELVERMISMATCH                                               \
  (AEE_EOFFSET + 0x194) ///<  Stub version cannot be greater than skel version
