...
//
//
#define DSP_AEE_EOFFSET 0x80000400
...
// Kernel error code start
#define KERNEL_ERRNO_START -1024
// Userspace error code end
#define HLOS_ERR_END 1024
...
#define AEE_ENOMEMORY                                                         \
	(AEE_EOFFSET                                                          \
	 + 0x002) ///< Memory allocation failed because of insufficient RAM
#define AEE_ECLASSNOTSUPPORT                                                  \
	(AEE_EOFFSET + 0x003) ///< Specified class unsupported
...
#define AEE_EUNABLETOLOAD                                                     \
	(AEE_EOFFSET + 0x006) ///< Unable to load object/applet
#define AEE_EUNABLETOUNLOAD                                                   \
	(AEE_EOFFSET + 0x007)                   ///< Unable to unload
	                                        ///< object/applet
...
#define AEE_EBADSTATE                                                         \
	(AEE_EOFFSET + 0x00D) ///< Process or thread is not in expected state
...
#define AEE_EINCOMPLETEITEM                                                   \
	(AEE_EOFFSET + 0x012) ///< Incomplete item, like length of a string is
	                      ///< less that expected
...
#define AEE_EPRIVLEVEL                                                        \
	(AEE_EOFFSET + 0x015) ///< Privileges are insufficient
	                      ///< for this operation
#define AEE_ERESOURCENOTFOUND                                                 \
	(AEE_EOFFSET + 0x016) ///< Unable to find specified
	                      ///< resource
#define AEE_EREENTERED                                                        \
	(AEE_EOFFSET + 0x017) ///< Non re-entrant API
	                      ///< re-entered
#define AEE_EBADTASK                                                          \
	(AEE_EOFFSET + 0x018) ///< API called in wrong task
	                      ///< context
#define AEE_EALLOCATED                                                        \
	(AEE_EOFFSET + 0x019) ///< App/Module left memory
	                      ///< allocated when released.
#define AEE_EALREADY                                                          \
	(AEE_EOFFSET + 0x01A) ///< Operation is already in
	                      ///< progress
#define AEE_EADSAUTHBAD                                                       \
	(AEE_EOFFSET + 0x01B) ///< ADS mutual authorization
	                      ///< failed
#define AEE_ENEEDSERVICEPROG                                                  \
	(AEE_EOFFSET + 0x01C) ///< Need service programming
#define AEE_EMEMPTR                                                           \
	(AEE_EOFFSET + 0x01D) ///< bad memory pointer, expected to be NULL
#define AEE_EHEAP                                                             \
	(AEE_EOFFSET + 0x01E) ///< An internal heap error was detected
#define AEE_EIDLE                                                             \
	(AEE_EOFFSET + 0x01F) ///< Context (system, interface,
	                      ///< etc.) is idle
#define AEE_EITEMBUSY                                                         \
	(AEE_EOFFSET + 0x020)               ///< Context (system, interface,
	                                    ///< etc.) is busy
...
#define AEE_EADSCAPS                                                          \
	(AEE_EOFFSET + 0x024) ///< ADS Capabilities do not
	                      ///< match those required for phone
#define AEE_EBADSHUTDOWN                                                      \
	(AEE_EOFFSET + 0x025) ///< App failed to close properly
#define AEE_EBUFFERTOOSMALL                                                   \
	(AEE_EOFFSET + 0x026)                 ///< Destination buffer given is
	                                      ///< too small
	                                      ///< or service exists or is
	                                      ///< valid
#define AEE_EACKPENDING (AEE_EOFFSET + 0x028) ///< ACK pending on application
#define AEE_ENOTOWNER                                                         \
	(AEE_EOFFSET + 0x029) ///< Not an owner authorized to
	                      ///< perform the operation
#define AEE_EINVALIDITEM                                                      \
	(AEE_EOFFSET + 0x02A) ///< Current item is invalid, it can be a switch
	                      ///< case or a pointer to memory
#define AEE_ENOTALLOWED                                                       \
	(AEE_EOFFSET + 0x02B) ///< Not allowed to perform the
	                      ///< operation
#define AEE_EINVHANDLE                                                        \
	(AEE_EOFFSET                                                          \
	 + 0x02C) ///< Invalid handle - adding here as its defined in vendor
	          ///< AEEStdErr.h - needed to check valid handle in stub.c
#define AEE_EOUTOFHANDLES                                                     \
	(AEE_EOFFSET + 0x02D) ///< Out of handles (Handle list is already full)
// Hole here
#define AEE_ENOMORE                                                           \
	(AEE_EOFFSET + 0x02F)                   ///< No more items available --
	                                        ///< reached end
#define AEE_ECPUEXCEPTION (AEE_EOFFSET + 0x030) ///< A CPU exception occurred
#define AEE_EREADONLY                                                         \
	(AEE_EOFFSET                                                          \
	 + 0x031) ///< Cannot change read-only
...
#define AEE_EINTERRUPTED                                                      \
	(46) ///< Waitable call is interrupted,
	     ///< the user should return to the HLOS and retry the call
#define AEE_ECONNRESET (104) ///< Connection reset by peer
#define AEE_EWOULDBLOCK                                                       \
	(516) ///< Operation would block if not
...
#define AEE_EINVALIDMSG                                                       \
	(AEE_EOFFSET + 0x032) ///<  Invalid SMD message from APPS
...
#define AEE_EINVALIDDEVICE                                                    \
	(AEE_EOFFSET + 0x03B) ///<  Invalid Device or Device node open failed
	                      ///<  for the domain
...
#define AEE_ENOSUCHINSTANCE                                                   \
	(AEE_EOFFSET + 0x03F) ///<  No instance in the list lookup
#define AEE_ENOSUCHTHREAD (AEE_EOFFSET + 0x040)  ///<  No such thread
#define AEE_ENOSUCHPROCESS (AEE_EOFFSET + 0x041) ///<  No such process
#define AEE_ENOSUCHSYMBOL                                                     \
	(AEE_EOFFSET                                                          \
	 + 0x042) ///<  No such symbol( dlsym for the symbol failed)
...
#define AEE_ENOSUCHMAP                                                        \
	(AEE_EOFFSET + 0x048) ///<  No mapping exists for this address on DSP
...
#define AEE_EFOPEN                                                            \
	(AEE_EOFFSET + 0x057) ///<  file open error or device node open failed
	                      ///<  for DSP domain
...
#define AEE_ENORPCMEMORY                                                      \
	(AEE_EOFFSET + 0x068) ///<  ION memory allocation failed
#define AEE_ENOROOTOFTRUST                                                    \
	(AEE_EOFFSET + 0x069) ///<  No root of trust for sigverify
#define AEE_ENOTLOCKED                                                        \
	(AEE_EOFFSET + 0x06A) ///<  Unlock failed, not locked before
#define AEE_ENOTINITIALIZED (AEE_EOFFSET + 0x06B) ///<  Not initialized
#define AEE_EUNSUPPORTEDAPI                                                   \
	(AEE_EOFFSET + 0x06C)             ///<  unsupported API/request ID
...
#define AEE_EUNSIGNEDMOD                                                      \
	(AEE_EOFFSET + 0x081) ///<  test-sig not found, Unsigned shared object
#define AEE_EINVALIDHASH                                                      \
	(AEE_EOFFSET + 0x082) ///<  test-sig not found, Invalid hash object
...
#define AEE_ENOFREESECTION                                                    \
	(AEE_EOFFSET + 0x088) ///<  No more free sections available
#define AEE_U2GCLIENT_OPEN (AEE_EOFFSET + 0x089) ///<  u2g client open failed
#define AEE_ENOSESSION (AEE_EOFFSET + 0x08A)     /// No available session
...
#define AEE_EGLINKALREADYOPEN                                                 \
	(AEE_EOFFSET + 0x102) ///<  SMD port is already open
...
#define AEE_EGLINKREGISTER                                                    \
	(AEE_EOFFSET + 0x105) ///<  SMD port register callback failed
#else
...
#define AEE_EDALINTREGISTER                                                   \
	(AEE_EOFFSET + 0x122) ///<  DAL interrupt register error
#define AEE_EDALINTUNREGISTER                                                 \
	(AEE_EOFFSET + 0x123) ///<  Dal interrupt unregister error
...
#define AEE_EQURTREGIONCREATE                                                 \
	(AEE_EOFFSET + 0x141) ///<  QURT region create failed
#define AEE_EQURTCACHECLEAN (AEE_EOFFSET + 0x142) ///<  QURT cache clean failed
#define AEE_EQURTREGIONGETATTR                                                \
	(AEE_EOFFSET + 0x143) ///<  QURT region get attribute failed
#define AEE_EQURTBADREGIONPERMS                                               \
	(AEE_EOFFSET + 0x144) ///<  QURT bad permissions for region
#define AEE_EQURTMEMPOOLADD                                                   \
	(AEE_EOFFSET + 0x145) ///<  QURT Add to memory pool failed
#define AEE_EQURTREGISTERDEV                                                  \
	(AEE_EOFFSET + 0x146) ///<  QURT register device failed
#define AEE_EQURTMEMPOOLCREATE                                                \
	(AEE_EOFFSET + 0x147) ///<  QURT create memory pool failed
#define AEE_EQURTGETVA (AEE_EOFFSET + 0x148) ///<  QURT get VA failed
#define AEE_EQURTREGIONDELETE                                                 \
	(AEE_EOFFSET + 0x149) ///<  QURT region delete failed
#define AEE_EQURTMEMPOOLATTACH                                                \
	(AEE_EOFFSET + 0x14A) ///<  QURT memory pool attach failed
#define AEE_EQURTTHREADCREATE                                                 \
	(AEE_EOFFSET + 0x14B) ///<  QURT thread create failed
#define AEE_EQURTCOPYTOUSER                                                   \
	(AEE_EOFFSET + 0x14C) ///<  QURT copy to user memory failed
#define AEE_EQURTMEMMAPCREATE                                                 \
	(AEE_EOFFSET + 0x14D) ///<  QURT map create failed
#define AEE_EQURTINVHANDLE                                                    \
	(AEE_EOFFSET + 0x14E)                  ///<  QURT Invalid client handle
...
#define AEE_EQURTCOPYFROMUSER                                                 \
	(AEE_EOFFSET + 0x151) ///<  QURT Copy from user failed
#define AEE_EQURTLINELOCK (AEE_EOFFSET + 0x152) ///<  QURT Line lock failed
#define AEE_EQURTQDIDEFMETHOD                                                 \
	(AEE_EOFFSET + 0x153) ///<  QURT QDI default method failed
#define AEE_EQURTCREATEHANDLE                                                 \
	(AEE_EOFFSET + 0x154) ///<  QURT create handle from obj failed
#define AEE_EQURTWRITABLEMEM                                                  \
	(AEE_EOFFSET + 0x155) ///<  QURT CPZ migration writable mem
#define AEE_EQURTTHREADCREATEDEF                                              \
	(AEE_EOFFSET + 0x156)                   ///<  QURT thread create def
#define AEE_EQURTLOOKUPVA (AEE_EOFFSET + 0x157) ///<  QURT lookup VA
#define AEE_EQURTLOOKUPPA (AEE_EOFFSET + 0x158) ///<  QURT lookup PA
#define AEE_EQURTMIGRATESECURE                                                \
	(AEE_EOFFSET + 0x159)                  ///<  QURT CPZ migration failure
...
#define AEE_EMMPMREQUEST                                                      \
	(AEE_EOFFSET + 0x171) ///<  MMPM Power request to failed
#define AEE_EMMPMRELEASE                                                      \
	(AEE_EOFFSET + 0x172) ///<  MMPM Release request failed
#define AEE_EMMPMSETPARAM                                                     \
	(AEE_EOFFSET + 0x173) ///<  MMPM set param request failed
#define AEE_EMMPMREGISTER                                                     \
	(AEE_EOFFSET + 0x174) ///<  MMPM Register request failed
#define AEE_EMMPMGETINFO (AEE_EOFFSET + 0x175) ///<  MMPM Get info failed
#define AEE_EMAX_MMPM_CLIENTS                                                 \
	(AEE_EOFFSET                                                          \
	 + 0x176) ///<  MMPM Reached maximum clients per PD(HAP_MAX_CLIENTS)
#define AEE_EDCVSREGISTER                                                     \
	(AEE_EOFFSET + 0x177) ///<  ADSP DCVS client registration failed
#define AEE_PDRREGFAIL                                                        \
	(AEE_EOFFSET                                                          \
	 + 0x178) ///<  Error Callback Services Registration failed for PD

/**
 * @}
 */

#define AEE_DEFAULT_PROCESS                                                   \
	(AEE_EOFFSET + 0x180) ///<  Default process in Guest OS is not present
...
#define E_APPS_BUSY_RETRY_LATER                                               \
	(AEE_EOFFSET + 0x190) ///<  Retry because the apps is busy
#define E_HLOS_CAP_REACHED                                                    \
	(AEE_EOFFSET + 0x191) ///<  cannot allocate any more hlos mem
#define E_DPOOL_CAP_REACHED                                                   \
	(AEE_EOFFSET + 0x192) ///<  cannot allocate any more physpool mem
#define E_NO_MORE_FREE_SECTIONS                                               \
	(AEE_EOFFSET                                                          \
	 + 0x193) ///<  No more free sections available to grow heap

/** @defgroup stub skel version mismatch error code
 *  @{
 */

#define AEE_ESTUBSKELVERMISMATCH                                              \
	(AEE_EOFFSET                                                          \
	 + 0x194) ///<  Stub version cannot be greater than skel version
