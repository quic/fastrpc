...
#ifndef _ADSP_DEFAULT_LISTENER1_H
#define _ADSP_DEFAULT_LISTENER1_H
#include <AEEStdDef.h>
#include <remote.h>
#include <string.h>
#include <stdlib.h>
...
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_default_listener1_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/**
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_default_listener1_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_default_listener1_register)(remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
#ifndef adsp_default_listener1_URI
#define adsp_default_listener1_URI "file:///libadsp_default_listener1_skel.so?adsp_default_listener1_skel_handle_invoke&_modver=1.0"
#endif /*adsp_default_listener1_URI*/
#ifdef __cplusplus
}
#endif
#endif //_ADSP_DEFAULT_LISTENER1_H
