 ...
 * @retval, 0 on success
 */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_default_listener1_open)(
...
/**
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_default_listener1_close)(
    remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_default_listener1_register)(
    remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
#ifndef adsp_default_listener1_URI
#define adsp_default_listener1_URI                                            \
	"file:///"                                                            \
	"libadsp_default_listener1_skel.so?adsp_default_listener1_skel_"      \
	"handle_invoke&_modver=1.0"
