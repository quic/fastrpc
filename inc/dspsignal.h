 ...
 *                           within the range specified above (i.e.
 * <DSPSIGNAL_NUM_SIGNALS)
 ...
 *         - AEE_EUNSUPPORTED: Signals not supported with the given remote
 * endpoint or support not present in the FastRPC driver
