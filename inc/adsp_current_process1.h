 ...
 * @retval, 0 on success
 */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process1_open)(
...
/**
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process1_close)(
...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process1_thread_exit)(
    remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(adsp_current_process1_set_logging_params)(
        remote_handle64 _h, unsigned short mask, const _cstring1_t *filesToLog,
        int filesToLogLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process1_getASID)(
    remote_handle64 _h, unsigned int *asid) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process1_setQoS)(
    remote_handle64 _h, unsigned int latency) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process1_exception)(
    remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(adsp_current_process1_set_logging_params2)(
        remote_handle64 _h, unsigned int mask, const _cstring1_t *filesToLog,
        int filesToLogLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process1_poll_mode)(
    remote_handle64 _h, unsigned int enable,
    unsigned int timeout) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int
    __QAIC_HEADER(adsp_current_process1_enable_notifications)(
        remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process1_panic_err_codes)(
    remote_handle64 _h, const int *err_codes,
    int err_codesLen) __QAIC_HEADER_ATTRIBUTE;
#ifndef adsp_current_process1_URI
#define adsp_current_process1_URI                                              \
  "file:///"                                                                   \
  "libadsp_current_process1_skel.so?adsp_current_process1_skel_handle_invoke&" \
  "_modver=1.0"
